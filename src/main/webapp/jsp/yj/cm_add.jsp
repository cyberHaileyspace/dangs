	...
	<div class="container-add">
		...
		<div>카테고리</div>
			<div class="add-category">
				<input type="radio" id="cm-tip" name="cm-category"><label for="cm-tip">반려 꿀팁</label>
				<input type="radio" id="cm-proud" name="cm-category"><label for="cm-proud">우리 멍멍</label>
				<input type="radio" id="cm-diary" name="cm-category"><label for="cm-diary">집사 일기</label>
				<input type="radio" id="cm-qna" name="cm-category"><label for="cm-qna">Q&A</label>
			</div>
		</div>
		...
		<div class="add-title">
			<div>제목</div>
		 	<div class="add-ta"><textarea rows="" cols="" placeholder="제목을 입력하세요."></textarea></div>
		 </div>
